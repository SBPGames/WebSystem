 ...
 * PROJECT_VENDOR vendor at namespace's top-level) - or in the librairies folder
 * (LIBRARIES_FOLDER).
 * 
 * **NOTE:** This function lets `require_once` throw warnings; otherwise its
 * final E_COMPILE_ERROR shouldn't be thrown because enough verifications are
 * made.
 *
 ...
 * 		- If `$classname` doesn't have a (valid) vendor name as namespace's
 * 		top-level (PHP, PSR-1 and PSR-4);
